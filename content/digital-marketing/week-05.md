...
module: "Module 4: Paid Advertising (PPC & Google Ads)"
week: 5
topics:
  - Google Ads fundamentals (search, display, shopping campaigns)
...
# Week 5 Lecture Script: Paying for Immediate, Deliberate Reach
...
Tightly themed ad groups — rather than mixing many loosely related keywords together in one broad group — allow for genuinely relevant, specific ad copy for each distinct group, which directly supports the Quality Score we just discussed.
