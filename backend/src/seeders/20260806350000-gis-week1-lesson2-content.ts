...
// duplicate Day 2 Lesson 1 ("Latitude, Longitude, and Map Projections" in
// curriculumGis.ts, which already has a full quiz bank on that exact topic) -- the
// Day 1 lecture script itself explicitly defers coordinate systems to "next day."
// User chose to rename this lesson (rather than write duplicate content or leave the
// title inaccurate) to reflect what the Day 1 script actually left unused: real-world
