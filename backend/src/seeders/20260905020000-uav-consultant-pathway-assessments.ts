...
const ASSESSMENTS: AssessmentSeed[] = [
  ...
  },
  {
    ...
    weekNumber: 11,
    description: "Covers Days 10-11: client requirements, mission design (altitude/overlap/geofence), simulation, safety, risk, and the country's UAV regulation.",
    questions: [
      ...
      { text: "Which authority regulates UAV operations in the country?", type: "multiple_choice", explanation: null, answers: [{ text: "FAA", isCorrect: false }, { text: "CAA", isCorrect: false }, { text: "NCAA", isCorrect: true }] },
      { text: "A UAV rule that applies in the UK automatically applies the same way in the country and the US.", type: "true_false", explanation: null, answers: [{ text: "True", isCorrect: false }, { text: "False", isCorrect: true }] },
