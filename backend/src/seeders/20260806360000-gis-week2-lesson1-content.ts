...
const PLACEHOLDER_CONTENT =
  "How coordinate systems locate points on Earth, and why every flat map projection — including UTM, used across the country — involves some tradeoff in accuracy.";
