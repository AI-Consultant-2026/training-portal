...
export const CAPSTONE_SPECS: Record<string, BriefSpec> = {
  "cyber-security-fundamentals": {
    ...
    tasks: [
      ...
      "Draw on **specific concepts from Days 1-12** and name the concept when you use it (for example \"least privilege\" or \"the containment phase\"). Do not treat the sector pathway as separate from the core.",
    ...
    criteria: [
      ...
      { name: "Application of core fundamentals", points: 25, description: "Visibly draws on specific Days 1-12 concepts (authentication, phishing, malware, network security, access control, incident response, data protection)." },
  ...
  "digital-marketing": {
    ...
    tasks: [
      ...
      "**Situation and audience.** Describe the business, then present **at least two buyer personas** and a short **competitive review** (from Day 2).",
      "**Goals and KPIs.** State one main **SMART goal** and the **KPI** for each channel, taken from your Day 8 scope.",
  ...
  "gis-and-drone-mapping": {
    overview:
      "This capstone brings the whole course together in **one connected project**. Choose **one of the seven sector tracks** below (or an equivalent planning question in a similar sector) and carry it all the way from a data collection plan through remote sensing, a drone component, spatial analysis, thematic mapping and a stakeholder-focused report. Your choices at each stage should directly support the next: your data collection plan feeds your remote sensing and drone work, which feeds your spatial analysis, all clearly communicated through your maps and report.\n\nScope it realistically. A focused, well-executed analysis of **one specific area or one specific constraint** will serve you and any real stakeholder far better than a thin attempt to cover everything.",
    materials:
      "### Choose one sector track\n\n**Oil & Gas.** A fictional operator needs to check whether its pipeline right-of-way has been encroached on, or wants environmental monitoring around a facility. *Example question:* \"Has land cover along this pipeline corridor changed in a way that suggests encroachment or an unreported spill?\"\n\n**Banking & Financial Services.** A fictional bank is deciding where to open its next branches or ATMs, or wants to assess a property portfolio. *Example question:* \"Which three locations in this city give the bank the strongest new-branch catchment, accounting for population, competitor branches and road access?\" Drone work here will usually be the written specification option below, not a flight -- say why in your report.\n\n**Telecommunications.** A fictional mobile network operator is planning tower coverage or a fibre route. *Example question:* \"Where should the next two towers go to close this coverage gap, and what is the most realistic fibre route to connect them?\"\n\n**Mining.** A fictional quarry or mine needs a stockpile volume, terrain analysis or environmental disturbance check. *Example question:* \"What is the current volume of this stockpile, and how has the site's disturbed area changed over the last two survey dates?\"\n\n**Environmental Management.** A State ministry or NGO needs land-use, flood-risk, or vegetation-health analysis -- this track can also take the course's original framing, **sustainable agriculture zone planning** (for example water access or soil suitability for expanding a specific crop). *Example question:* \"Which zones are best suited to expanding cassava farming with the water and road access available?\" or \"Which neighbourhoods face the highest flood risk?\"\n\n**Construction.** A fictional contractor or project owner needs a site survey, progress monitoring, or an earthworks volume. *Example question:* \"How much cut-and-fill volume does this site need, and how would monthly drone flights track progress against it?\"\n\n**Infrastructure.** A fictional road agency or utility needs asset mapping, right-of-way checking, or inspection of a bridge or drainage network. *Example question:* \"Which sections of this road corridor's right-of-way have been encroached on, and what condition is the drainage network in?\"",
    tasks: [
      "**Define the project.** State which **sector track** you chose (or a comparable question in a similar sector) and one **study area** (about 5-30 km across, or a single site for construction, mining or infrastructure work). State your one **planning question** and name the **stakeholders** (for example a ministry, a bank's branch-planning team, a network operator, or a site owner).",
      "**Data collection plan.** Use your Day 3 approach: layers needed, sources, accuracy needs, licences and validation steps.",
      "**Remote sensing analysis.** Use satellite imagery to calculate at least one **spectral index** (for example NDVI) or a **change detection** between two dates (Day 4), if genuinely relevant to your question. If your track is one where this does not apply well (for example a single-site construction or mining survey), say so and explain why, then rely more heavily on your drone component instead.",
      "**Drone survey component.** Either **(a)** plan and fly a small survey yourself, following the regulations in Day 5, or **(b)** if you cannot fly, use **open drone imagery** (for example from OpenAerialMap) for your area, *or* **(c)** write a **complete drone survey specification** (Day 6) for the site you would survey, including the GSD and flight-height calculation. If your track is one where a drone genuinely adds little value (most Banking questions, for instance), you may instead write a short, honest paragraph explaining why, citing Day 9's reasoning, and lean more on satellite or vector analysis for the rest.",
      "**Spatial analysis.** Carry out a **suitability, constraint, or catchment analysis** using at least **three layers** and at least two techniques (for example buffering, overlay, reclassification, weighted overlay or network analysis). Document the settings and your reasoning for any weights.",
      "**Thematic maps.** Produce **at least five well-designed maps** (Day 7) that build the story from inputs to final result.",
      ...
      "**Project plan.** Include the timeline and resource plan (Day 8) for carrying out the recommended follow-up work.",
    ],
    deliverables: [
      ...
      "A short **appendix** with your calculations (GSD and flight height, area figures, or catchment/volume figures) and any key settings.",
    ],
    criteria: [
      { name: "Project definition and data plan", points: 15, description: "A focused question in one sector track, real stakeholders and a sound data collection plan." },
      { name: "Remote sensing and drone work", points: 25, description: "Correct index or change analysis where relevant, a completed drone component or a well-justified alternative with correct calculations, and honest limitations." },
      { name: "Spatial analysis", points: 25, description: "Appropriate layers and techniques for the chosen sector, documented settings and justified weights leading to a sensible result." },
  ...
  "hse-fundamentals": {
    ...
    tasks: [
      ...
      "**Environmental protection and spill response.** A plan appropriate to the facility's location using the **7-step framework** from Day 7, reflecting the specific hazards you identified.",
      "**Audit and review.** A short section on how you would audit the plan (linking to your Day 8 checklist) and keep it up to date.",
    ],
    deliverables: [
