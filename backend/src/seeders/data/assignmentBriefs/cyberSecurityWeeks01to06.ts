...
// Cyber Security Fundamentals, Days 1-6. Keyed by module week_number.
export const CYBER_WEEKS_1_TO_6: Record<number, BriefSpec> = {
  1: {
    overview:
      "Every serious breach starts with a way in. In this assignment you act as a junior analyst writing a short briefing for a manager who asks: *\"How do these attacks actually happen, and who is behind them?\"* You will research three real, publicly reported data breaches and break each one down using the vocabulary from this day's lessons: **attack vector**, **vulnerability** and **threat actor**.",
    tasks: [
  ...
  2: {
    ...
    tasks: [
      ...
      "Explain in 3-4 sentences how your recommendations reduce the risk of **credential theft and account takeover**, using ideas from this day's lessons.",
    ],
    deliverables: [
  ...
  3: {
    ...
    tips: [
      ...
      "Do not put everything in one big \"internal\" zone. That is exactly the flat network this day warned against.",
