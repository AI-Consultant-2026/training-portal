...
4. Outline a basic incident-response plan (using the six-phase lifecycle from Week 9) tailored to this facility, including who gets notified and in what order.
...
**Tasks.**
1. Diagnose the account-takeover pattern described above: identify the likely attack chain (what information or access the attacker needed, and how they probably obtained it), referencing this course's Week 2 (Authentication) and Week 5 (Social Engineering) content specifically.
...
- **Application of core fundamentals (25 points):** the submission visibly draws on specific concepts from Weeks 1-12 (authentication, phishing, malware, network security, access control, incident response, data protection) rather than treating the sector pathway as disconnected from the core.
