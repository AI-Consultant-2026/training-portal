...
This lesson covered risk registers as living documents, third-party risk as a category too many organisations underweight, and how compliance frameworks like the NDPA, GDPR, and PCI-DSS turn some security decisions from a choice into a legal or contractual obligation. Next day turns from managing risk in general to a specific, high-value control this entire course keeps returning to: access control and identity management.`,
    ...
    quizQuestions: [
      ...
      { text: "What is the Data Protection Act (NDPA) 2023?", type: "multiple_choice", points: 1, explanation: null, answers: [{ text: "The country's current, legally binding data protection framework, enforced by the NDPC", isCorrect: true }, { text: "A voluntary, non-binding set of guidelines with no enforcement body", isCorrect: false }, { text: "An international standard unrelated to Nigerian law", isCorrect: false }] },
      { text: "What replaced the earlier Data Protection Regulation (NDPR)?", type: "multiple_choice", points: 1, explanation: null, answers: [{ text: "The Data Protection Act (NDPA) 2023, enforced by the NDPC", isCorrect: true }, { text: "Nothing; the NDPR remains the country's only data protection framework", isCorrect: false }, { text: "GDPR directly, with no Nigerian-specific law involved", isCorrect: false }] },
...
Most modern data protection regulations, including Module 7's GDPR and the country's NDPA, include specific **breach notification requirements** -- legal obligations to notify affected individuals, and often the relevant regulator, within a defined time window after a breach involving personal data is discovered.

GDPR generally requires notification to the relevant regulator within **seventy-two hours** of an organisation becoming aware of a qualifying breach, measured from the moment of discovery. The country's NDPA similarly requires data controllers to notify the Data Protection Commission of a breach that's likely to result in a risk to the rights of affected individuals, on a defined timeline, and in serious cases, to notify the affected individuals directly. The exact details of any regulation's timelines and thresholds are worth verifying against the regulator's current published guidance before relying on them for a real compliance decision -- these requirements are actively maintained and can be updated.
