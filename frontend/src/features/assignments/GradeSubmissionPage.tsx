...
import { fetchSubmissionForGrading, gradeSubmission } from "./assignmentsSlice";
...
export function GradeSubmissionPage() {
  ...
  async function handleDownload() {
    ...
    try {
      ...
      await assignmentsApi.downloadSubmissionFile(id, fileName);
    } catch {
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-10">
      <h1 className="text-2xl font-semibold text-gray-900">{submission.assignmentTitle}</h1>
